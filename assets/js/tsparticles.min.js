        ...
        714: (t, i, e) => {
          e.r(i),
            e.d(i, {
              ...
              EmitterClickMode: () => he,
              HoverMode: () => d,
              InlineArrangement: () => pe,
              InteractivityDetect: () => x,
              MoveDirection: () => n,
              MoveType: () => ye,
              OutMode: () => u,
              ProcessBubbleType: () => m,
          ...
          class r {
            ...
            static getValue(t) {
              ...
              return e ? r.randomInRange(o, t.value) : t.value;
            }
            ...
            static rotateVelocity(t, i) {
              return {
                horizontal:
                  t.horizontal * Math.cos(i) - t.vertical * Math.sin(i),
            ...
            static collisionVelocity(t, i, e, o) {
              return {
                horizontal:
                  (t.horizontal * (e - o)) / (e + o) +
                  (2 * i.horizontal * o) / (e + o),
                vertical: t.vertical,
              };
            }
          }
          ...
          class P {
            ...
            static itemFromArray(t, i, e = !0) {
              return t[
                void 0 !== i && e ? i % t.length : P.arrayRandomIndex(t)
              ];
            }
            static isPointInside(t, i, e, o) {
              return P.areBoundsInside(
                P.calculateBounds(t, null != e ? e : 0),
                i,
                o
              );
            }
            static areBoundsInside(t, i, e) {
              let o = !0;
              return (
                (e && e !== s.bottom) || (o = t.top < i.height),
                !o || (e && e !== s.left) || (o = t.right > 0),
                !o || (e && e !== s.right) || (o = t.left < i.width),
                !o || (e && e !== s.top) || (o = t.bottom > 0),
                o
              );
            }
            ...
            static downloadSvgImage(t) {
              return k(this, void 0, void 0, function* () {
                ...
                if ("svg" !== i.type) return P.loadImage(t);
            ...
            static isDivModeEnabled(t, i) {
              return i instanceof Array
                ? !!i.find((i) => i.enable && P.isInArray(t, i.mode))
                : P.isInArray(t, i.mode);
            }
            static divModeExecute(t, i, e) {
              if (i instanceof Array)
                for (const o of i) {
                  const i = o.mode;
                  o.enable && P.isInArray(t, i) && P.singleDivModeExecute(o, e);
                }
              else {
                const o = i.mode;
                i.enable && P.isInArray(t, o) && P.singleDivModeExecute(i, e);
              }
            }
            ...
            static circleBounceDataFromParticle(t) {
              return {
                ...
                velocity: t.velocity,
                factor: {
                  horizontal: r.getValue(t.particlesOptions.bounce.horizontal),
                  vertical: r.getValue(t.particlesOptions.bounce.vertical),
                },
              };
            }
            static circleBounce(t, i) {
              const e = t.velocity.horizontal,
                o = t.velocity.vertical,
                s = t.position,
                n = i.position;
              if (e * (n.x - s.x) + o * (n.y - s.y) >= 0) {
                const e = -Math.atan2(n.y - s.y, n.x - s.x),
                  o = t.radius,
                  a = i.radius,
                  l = r.rotateVelocity(t.velocity, e),
                  c = r.rotateVelocity(i.velocity, e),
                  d = r.collisionVelocity(l, c, o, a),
                  h = r.collisionVelocity(c, l, o, a),
                  u = r.rotateVelocity(d, -e),
                  v = r.rotateVelocity(h, -e);
                (t.velocity.horizontal = u.horizontal * t.factor.horizontal),
                  (t.velocity.vertical = u.vertical * t.factor.vertical),
                  (i.velocity.horizontal = v.horizontal * i.factor.horizontal),
                  (i.velocity.vertical = v.vertical * i.factor.vertical);
              }
            }
            static rectBounce(t, i) {
              const e = t.getPosition(),
                o = t.getRadius(),
                s = P.calculateBounds(e, o),
                n = z(
                  { min: s.left, max: s.right },
                  { min: s.top, max: s.bottom },
                  { min: i.left, max: i.right },
                  { min: i.top, max: i.bottom },
                  t.velocity.horizontal,
                  r.getValue(t.particlesOptions.bounce.horizontal)
                );
              n.bounced &&
                (void 0 !== n.velocity && (t.velocity.horizontal = n.velocity),
              ...
              const a = z(
                ...
                { min: i.left, max: i.right },
                t.velocity.vertical,
                r.getValue(t.particlesOptions.bounce.vertical)
              );
              a.bounced &&
                (void 0 !== a.velocity && (t.velocity.vertical = a.velocity),
          ...
          (S.canvasClass = "tsparticles-canvas-el"),
            (S.randomColorValue = "random"),
            (S.midColorValue = "mid"),
            (S.touchEndEvent = "touchend"),
            (S.mouseDownEvent = "mousedown"),
            (S.mouseUpEvent = "mouseup"),
            (S.mouseMoveEvent = "mousemove"),
            (S.touchStartEvent = "touchstart"),
            (S.touchMoveEvent = "touchmove"),
            (S.mouseLeaveEvent = "mouseleave"),
            (S.mouseOutEvent = "mouseout"),
            (S.touchCancelEvent = "touchcancel"),
            (S.resizeEvent = "resize"),
            (S.visibilityChangeEvent = "visibilitychange"),
            (S.noPolygonDataLoaded = "No polygon data loaded."),
            (S.noPolygonFound =
          ...
          class A {
            static colorToRgb(t, i, e = !0) {
              ...
              if ("string" == typeof a.value)
                r =
                  a.value === S.randomColorValue
                    ? A.getRandomRgbColor()
                    : A.stringToRgb(a.value);
              else if (a.value instanceof Array) {
                const t = P.itemFromArray(a.value, i, e);
                r = A.colorToRgb({ value: t });
              } else {
                const t = a.value,
                ...
                if (void 0 !== i.r) r = i;
                  ...
                  if (void 0 !== i.h && void 0 !== i.l) r = A.hslToRgb(i);
                  else {
                    const i =
                      null !== (n = t.hsv) && void 0 !== n ? n : a.value;
                    void 0 !== i.h && void 0 !== i.v && (r = A.hsvToRgb(i));
                  }
                }
              }
              return r;
            ...
            static colorToHsl(t, i, e = !0) {
              const o = A.colorToRgb(t, i, e);
              return void 0 !== o ? A.rgbToHsl(o) : void 0;
            }
            static rgbToHsl(t) {
              const i = t.r / 255,
                e = t.g / 255,
            ...
            static stringToAlpha(t) {
              var i;
              return null === (i = C(t)) || void 0 === i ? void 0 : i.a;
            }
            ...
            static rgbaToHsva(t) {
              const i = A.rgbToHsv(t);
              return { a: t.a, h: i.h, s: i.s, v: i.v };
            }
            static getRandomRgbColor(t) {
              const i = null != t ? t : 0;
              return {
                b: Math.floor(r.randomInRange(i, 256)),
                g: Math.floor(r.randomInRange(i, 256)),
                r: Math.floor(r.randomInRange(i, 256)),
              };
            }
            ...
            static getStyleFromHsv(t, i) {
              return A.getStyleFromHsl(A.hsvToHsl(t), i);
            }
            static mix(t, i, e, o) {
              let s = t,
                n = i;
              return (
                void 0 === s.r && (s = A.hslToRgb(t)),
                void 0 === n.r && (n = A.hslToRgb(i)),
                {
                  b: r.mix(s.b, n.b, e, o),
                  g: r.mix(s.g, n.g, e, o),
                  r: r.mix(s.r, n.r, e, o),
            ...
            static replaceColorSvg(t, i, e) {
              if (!t.svgData) return "";
              return t.svgData.replace(/#([0-9A-F]{3,6})/gi, () =>
                A.getStyleFromHsl(i, e)
              );
            }
            static getLinkColor(t, i, e) {
              var o, s;
              if (e === S.randomColorValue) return A.getRandomRgbColor();
              if ("mid" !== e) return e;
              {
                const e =
                    null !== (o = t.getFillColor()) && void 0 !== o
                      ...
                      : t.getStrokeColor(),
                  n =
                    null !== (s = null == i ? void 0 : i.getFillColor()) &&
                    void 0 !== s
                      ? s
                      : null == i
                      ? void 0
                      : i.getStrokeColor();
                if (e && n && i)
                  return A.mix(e, n, t.getRadius(), i.getRadius());
                {
                  const t = null != e ? e : n;
                  if (t) return A.hslToRgb(t);
                }
              }
            }
            static getLinkRandomColor(t, i, e) {
              const o = "string" == typeof t ? t : t.value;
              return o === S.randomColorValue
                ? e
                  ? A.colorToRgb({ value: o })
                  : i
                  ? S.randomColorValue
                  : S.midColorValue
                : A.colorToRgb({ value: o });
          ...
          class E {
            ...
            static drawLinkLine(t, i, e, o, s, n, a, l, c, d, h, u) {
              let v = !1;
              if (r.getDistance(e, o) <= s) T(t, e, o), (v = !0);
              else if (a) {
                let i, a;
                const l = { x: o.x - n.width, y: o.y },
                ...
                i && a && (T(t, e, i), T(t, o, a), (v = !0));
              }
              if (v) {
                if (
                  ((t.lineWidth = i),
                  l && (t.globalCompositeOperation = c),
                  (t.strokeStyle = A.getStyleFromRgb(d, h)),
                  u.enable)
                ) {
                  const i = A.colorToRgb(u.color);
                  i &&
                    ((t.shadowBlur = u.blur),
                    (t.shadowColor = A.getStyleFromRgb(i)));
                }
                t.stroke();
              }
            }
            static drawLinkTriangle(t, i, e, o, s, n, a, r) {
              !(function (t, i, e, o) {
                ...
                (t.fillStyle = A.getStyleFromRgb(a, r)),
                t.fill();
            }
            ...
            static gradient(t, i, e, o) {
              ...
              const r = i.getPosition(),
                l = e.getPosition(),
                c = A.mix(n, a, i.getRadius(), e.getRadius()),
                d = t.createLinearGradient(r.x, r.y, l.x, l.y);
              return (
                d.addColorStop(0, A.getStyleFromHsl(n, o)),
                d.addColorStop(s > 1 ? 1 : s, A.getStyleFromRgb(c, o)),
                d.addColorStop(1, A.getStyleFromHsl(a, o)),
                d
              );
            }
            static drawGrabLine(t, i, e, o, s, n) {
              t.save(),
                T(t, e, o),
                (t.strokeStyle = A.getStyleFromRgb(s, n)),
                (t.lineWidth = i),
                t.stroke(),
                t.restore();
            }
            static drawLight(t, i, e) {
              const o = t.options.interactivity.modes.light.area;
              i.beginPath(), i.arc(e.x, e.y, o.radius, 0, 2 * Math.PI);
              const s = i.createRadialGradient(e.x, e.y, 0, e.x, e.y, o.radius),
                n = o.gradient,
                a = {
                  start: A.colorToRgb(n.start),
                  stop: A.colorToRgb(n.stop),
                };
              a.start &&
                a.stop &&
                (s.addColorStop(0, A.getStyleFromRgb(a.start)),
                s.addColorStop(1, A.getStyleFromRgb(a.stop)),
                (i.fillStyle = s),
                i.fill());
            }
            static drawParticleShadow(t, i, e, o) {
              const s = e.getPosition(),
                n = t.options.interactivity.modes.light.shadow;
              i.save();
              const a = e.getRadius(),
                r = e.sides,
                l = (2 * Math.PI) / r,
              ...
              for (const t of d) {
                ...
                h.push({ endX: e, endY: s, startX: t.x, startY: t.y });
              }
              const v = A.colorToRgb(n.color);
              if (!v) return;
              const p = A.getStyleFromRgb(v);
              for (let t = h.length - 1; t >= 0; t--) {
                const e = t == h.length - 1 ? 0 : t + 1;
                i.beginPath(),
                  i.moveTo(h[t].startX, h[t].startY),
                  i.lineTo(h[e].startX, h[e].startY),
                  i.lineTo(h[e].endX, h[e].endY),
                  i.lineTo(h[t].endX, h[t].endY),
                  (i.fillStyle = p),
                  i.fill();
              }
              i.restore();
            ...
            static drawParticle(t, i, e, o, s, n, a, r, l, c, d) {
              ...
              const u =
                e.rotate.value +
                (e.particlesOptions.rotate.path ? e.pathAngle : 0);
              0 !== u && i.rotate(u), a && (i.globalCompositeOperation = r);
              const v = e.shadowColor;
              d.enable &&
                v &&
                ((i.shadowBlur = d.blur),
                (i.shadowColor = A.getStyleFromRgb(v)),
                (i.shadowOffsetX = d.offset.x),
                (i.shadowOffsetY = d.offset.y)),
                s && (i.fillStyle = s);
              const p = e.stroke;
              (i.lineWidth = e.strokeWidth),
                n && (i.strokeStyle = n),
                E.drawShape(t, i, e, l, c, o),
                p.width > 0 && i.stroke(),
                e.close && i.closePath(),
                e.fill && i.fill(),
                i.restore(),
                ...
                E.drawShapeAfterEffect(t, i, e, l, c, o),
                i.restore();
            }
            static drawShape(t, i, e, o, s, n) {
              if (!e.shape) return;
              const a = t.drawers.get(e.shape);
              a && a.draw(i, e, o, s, n.value, t.retina.pixelRatio);
            }
            static drawShapeAfterEffect(t, i, e, o, s, n) {
              if (!e.shape) return;
              const a = t.drawers.get(e.shape);
              (null == a ? void 0 : a.afterEffect) &&
                a.afterEffect(i, e, o, s, n.value, t.retina.pixelRatio);
            }
          ...
          class I extends O {
            ...
            contains(t) {
              const i = this.size.width,
                ...
                o = this.position;
              return (
                t.x >= o.x && t.x <= o.x + i && t.y >= o.y && t.y <= o.y + e
              );
            }
            intersects(t) {
              const i = t,
          ...
          class L extends D {
            ...
            intersects(t) {
              ...
              if (void 0 !== e.radius) {
                const t = new D(o.x, o.y, 2 * e.radius);
                return super.intersects(t);
              }
              if (void 0 !== i.size) {
                const t = new I(o.x, o.y, 2 * i.size.width, 2 * i.size.height);
                return super.intersects(t);
              }
              return !1;
            }
          }
          function H(t, i, e, o, s) {
            if (o) {
              let o = { passive: !0 };
          ...
          class F {
            ...
            manageListeners(t) {
              ...
              let n = S.mouseLeaveEvent;
              if (s === x.window)
                (e.interactivity.element = window), (n = S.mouseOutEvent);
              else if (s === x.parent && e.canvas.element) {
              ...
              (o.interactivity.events.onHover.enable ||
                ...
                (H(a, S.mouseMoveEvent, this.mouseMoveHandler, t),
                H(a, S.touchStartEvent, this.touchStartHandler, t),
                H(a, S.touchMoveEvent, this.touchMoveHandler, t),
                o.interactivity.events.onClick.enable
                  ? (H(a, S.touchEndEvent, this.touchEndClickHandler, t),
                    H(a, S.mouseUpEvent, this.mouseUpHandler, t),
                    H(a, S.mouseDownEvent, this.mouseDownHandler, t))
                  : H(a, S.touchEndEvent, this.touchEndHandler, t),
                H(a, n, this.mouseLeaveHandler, t),
                H(a, S.touchCancelEvent, this.touchCancelHandler, t)),
                e.canvas.element &&
                  (e.canvas.element.style.pointerEvents =
                    r === e.canvas.element ? "initial" : "none"),
                o.interactivity.events.resize &&
                  H(window, S.resizeEvent, this.resizeHandler, t),
                document &&
                  H(
                    document,
                    S.visibilityChangeEvent,
                    this.visibilityChangeHandler,
                    t,
                    !1
                  );
            ...
            mouseTouchMove(t) {
              ...
              if (
                void 0 ===
                (null === (i = l.interactivity) || void 0 === i
                  ? void 0
                  : i.element)
              )
                return;
              ...
              if (t.type.startsWith("mouse")) {
                ...
                if (l.interactivity.element === window) {
                ...
                } else if (c.interactivity.detectsOn === x.parent) {
                  const t = i.target,
                    s = i.currentTarget,
                    n = l.canvas.element;
                  if (t && s && n) {
                    ...
                    d = {
                      x:
                        null !== (e = i.offsetX) && void 0 !== e
                          ? e
                          : i.clientX,
                      y:
                        null !== (o = i.offsetY) && void 0 !== o
                          ? o
                          : i.clientY,
                    };
                } else
                  i.target === l.canvas.element &&
                    (d = {
                      x:
                        null !== (s = i.offsetX) && void 0 !== s
                          ? s
                          : i.clientX,
                      y:
                        null !== (n = i.offsetY) && void 0 !== n
                          ? n
                          : i.clientY,
                    });
              } else {
              ...
              d && ((d.x *= u), (d.y *= u)),
                ...
                (l.interactivity.status = S.mouseMoveEvent);
            }
            mouseTouchFinish() {
              const t = this.container.interactivity;
              if (void 0 === t) return;
          ...
          class B {
            static getPlugin(t) {
              return V.find((i) => i.id === t);
            }
            static addPlugin(t) {
              B.getPlugin(t.id) || V.push(t);
            }
            static getAvailablePlugins(t) {
              const i = new Map();
              for (const e of V)
                e.needsPlugin(t.options) && i.set(e.id, e.getPlugin(t));
              return i;
            }
            static loadOptions(t, i) {
              for (const e of V) e.loadOptions(t, i);
            }
            static getPreset(t) {
              return q.get(t);
            }
            static addPreset(t, i) {
              B.getPreset(t) || q.set(t, i);
            }
            static addShapeDrawer(t, i) {
              B.getShapeDrawer(t) || _.set(t, i);
            }
          ...
          class W {
            ...
            subdivide() {
              const t = this.rectangle.position.x,
                ...
                s = this.capacity;
              (this.northEast = new W(new I(t, i, e / 2, o / 2), s)),
                (this.northWest = new W(new I(t + e / 2, i, e / 2, o / 2), s)),
                (this.southEast = new W(new I(t, i + o / 2, e / 2, o / 2), s)),
                (this.southWest = new W(
                  new I(t + e / 2, i + o / 2, e / 2, o / 2),
                  s
                )),
                (this.divided = !0);
            }
            ...
            queryCircle(t, i) {
              return this.query(new D(t.x, t.y, i));
            }
            queryCircleWarp(t, i, e) {
              const o = e,
                s = e;
              return this.query(
                new L(t.x, t.y, i, void 0 !== o.canvas ? o.canvas.size : s)
              );
            }
            queryRectangle(t, i) {
              return this.query(new I(t.x, t.y, i.width, i.height));
            }
            query(t, i) {
              var e, o, s, n;
              const a = null != i ? i : [];
              ...
              for (const i of this.points)
                t.contains(i.position) && a.push(i.particle);
              return (
                this.divided &&
                  (null === (e = this.northEast) ||
                    void 0 === e ||
                    e.query(t, a),
                  null === (o = this.northWest) ||
                    void 0 === o ||
                    o.query(t, a),
                  null === (s = this.southEast) ||
                    void 0 === s ||
                    s.query(t, a),
                  null === (n = this.southWest) ||
                    void 0 === n ||
                    n.query(t, a)),
                a
              );
          ...
          class G {
            ...
            init(t) {
              ...
              return U(this, void 0, void 0, function* () {
                const e = t.options;
                if (
                  P.isInArray(g.char, e.particles.shape.type) ||
                  P.isInArray(g.character, e.particles.shape.type)
                ) {
                  const t =
                    null !== (i = e.particles.shape.options[g.character]) &&
                    void 0 !== i
                      ? i
                      : e.particles.shape.options[g.char];
                  if (t instanceof Array)
                    for (const i of t) yield P.loadFont(i);
                  else void 0 !== t && (yield P.loadFont(t));
                }
              });
            }
            draw(t, i, e) {
              ...
              void 0 === n.text &&
                (n.text =
                  s instanceof Array
                    ? P.itemFromArray(s, i.randomIndexData)
                    : s);
              const a = n.text,
                r = o.style,
                l = o.weight,
          ...
          class j {
            ...
            getImages(t) {
              ...
              return i.length
                ? i[0]
                : (this.images.push({ id: t.id, images: [] }),
                  this.getImages(t));
            }
            addImage(t, i) {
            ...
            init(t) {
              ...
              return $(this, void 0, void 0, function* () {
                ...
                if (
                  !P.isInArray(g.image, e.type) &&
                  !P.isInArray(g.images, e.type)
                )
                  return;
                const o =
                  null !== (i = e.options[g.images]) && void 0 !== i
                    ? i
                    : e.options[g.image];
            ...
            loadImageShape(t, i) {
              return $(this, void 0, void 0, function* () {
                try {
                  const e = i.replaceColor
                    ? yield P.downloadSvgImage(i.src)
                    : yield P.loadImage(i.src);
                  this.addImage(t, e);
                } catch (t) {
            ...
            draw(t, i, e, o) {
              ...
              if (!r) return;
              const l =
                  null !== (n = null == a ? void 0 : a.ratio) && void 0 !== n
                    ? n
                    : 1,
                c = { x: -e, y: -e };
          ...
          class tt {
            ...
            init() {
              ...
              this.resize();
              const u = this.container.options,
                v = this.element;
              v &&
                (u.backgroundMode.enable
                  ? ((this.originalStyle = P.deepExtend({}, v.style)),
                    (v.style.position = "fixed"),
                    (v.style.zIndex = u.backgroundMode.zIndex.toString(10)),
                    (v.style.top = "0"),
                    (v.style.left = "0"),
                    (v.style.width = "100%"),
                    (v.style.height = "100%"))
                  : ((v.style.position =
                    ...
                    (v.style.zIndex =
                      null !==
                        (o =
                          null === (e = this.originalStyle) || void 0 === e
                            ? void 0
                            : e.zIndex) && void 0 !== o
                        ? o
                        : ""),
                    (v.style.top =
                      null !==
                        (n =
                          null === (s = this.originalStyle) || void 0 === s
                            ? void 0
                            : s.top) && void 0 !== n
                        ? n
                        : ""),
                    ...
                    (v.style.width =
                      null !==
                        (c =
                          null === (l = this.originalStyle) || void 0 === l
                            ? void 0
                            : l.width) && void 0 !== c
                        ? c
                        : ""),
              ...
              (this.coverColor =
                void 0 !== m
                  ? { r: m.r, g: m.g, b: m.b, a: p.opacity }
                  : void 0),
                (this.trailFillColor = A.colorToRgb(f.fillColor)),
                this.initBackground(),
                this.paint();
            }
            loadCanvas(t, i) {
              var e;
              t.className || (t.className = S.canvasClass),
                this.generatedCanvas &&
                  (null === (e = this.element) || void 0 === e || e.remove()),
                (this.generatedCanvas = null != i ? i : this.generatedCanvas),
                (this.element = t),
                (this.originalStyle = P.deepExtend({}, this.element.style)),
            ...
            paint() {
              ...
              this.context &&
                ...
                this.coverColor
                  ? (E.clear(this.context, this.size),
                    this.paintBase(
                      A.getStyleFromRgb(this.coverColor, this.coverColor.a)
                    ))
                  : this.paintBase());
            }
            clear() {
              ...
              t.backgroundMask.enable
                ...
                ? this.paintBase(
                    A.getStyleFromRgb(this.trailFillColor, 1 / i.length)
                  )
                : this.context && E.clear(this.context, this.size);
            }
            windowResize() {
              ...
              const t = this.container;
              t.canvas.initSize(), t.particles.setDensity();
            ...
            initSize() {
              ...
              (t.canvas.size.width = this.element.offsetWidth * i),
                (t.canvas.size.height = this.element.offsetHeight * i),
                (this.element.width = t.canvas.size.width),
                (this.element.height = t.canvas.size.height);
            }
            drawConnectLine(t, i) {
              var e;
            ...
            drawParticleShadow(t, i) {
              this.context &&
                E.drawParticleShadow(this.container, this.context, t, i);
            }
            drawLinkTriangle(t, i, e) {
              ...
              if (!p) return;
              if (
                r.getDistance(h, u) > s.retina.linksDistance ||
                r.getDistance(v, u) > s.retina.linksDistance ||
                r.getDistance(v, h) > s.retina.linksDistance
              )
                return;
              let y = A.colorToRgb(c.color);
              if (!y) {
            ...
            drawLinkLine(t, i) {
              ...
              if (!d) return;
              let h;
              const u = t.particlesOptions.twinkle.lines;
              if (u.enable) {
                const t = u.frequency,
                  i = A.colorToRgb(u.color);
              ...
              const v =
                  null !== (e = t.linksWidth) && void 0 !== e
                    ...
                    : s.retina.linksWidth,
                p =
                  null !== (o = t.linksDistance) && void 0 !== o
                    ? o
              ...
              E.drawLinkLine(
                ...
                p,
                s.canvas.size,
                t.particlesOptions.links.warp,
                n.backgroundMask.enable,
                n.backgroundMask.composite,
                h,
                r,
                t.particlesOptions.links.shadow
              );
            }
            drawParticle(t, i) {
              var e, o, s, n;
              ...
              const l = this.container.options,
                c = t.particlesOptions.twinkle.particles,
                d = c.frequency,
                h = A.colorToRgb(c.color),
                ...
                w =
                  u && void 0 !== h
                    ...
                    ? A.hslToRgb(r)
                    : void 0,
                x = void 0 !== b ? A.getStyleFromRgb(b, p) : void 0;
              if (!this.context || (!x && !w)) return;
              const k =
                void 0 !== w
                  ? A.getStyleFromRgb(
                      w,
                      null !== (n = t.stroke.opacity) && void 0 !== n ? n : p
                    )
                  : x;
            ...
            drawParticleLinks(t) {
              ...
              const i = this.container,
                e = i.particles,
                o = t.particlesOptions;
              if (t.links.length > 0) {
                this.context.save();
                const s = t.links.filter(
                  (e) =>
                    i.particles.getLinkFrequency(t, e.destination) <=
                    o.links.frequency
                );
                for (const n of s) {
                  ...
                  if (o.links.triangles.enable) {
                    const r = s.map((t) => t.destination),
                      l = a.links.filter(
                        (t) =>
                          i.particles.getLinkFrequency(a, t.destination) <=
                            a.particlesOptions.links.frequency &&
                          r.indexOf(t.destination) >= 0
                      );
                    if (l.length)
                      for (const i of l) {
                        const s = i.destination;
                        e.getTriangleFrequency(t, a, s) >
                          o.links.triangles.frequency ||
                          this.drawLinkTriangle(t, n, i);
                      }
                  }
                  n.opacity > 0 &&
            ...
            drawLight(t) {
              this.context && E.drawLight(this.container, this.context, t);
            }
            paintBase(t) {
            ...
            initBackground() {
              ...
              const e = i.style;
              if (t.color) {
                const i = A.colorToRgb(t.color);
                i && (e.backgroundColor = A.getStyleFromRgb(i, t.opacity));
              }
          ...
          class et {
            ...
            updateLife(t) {
              ...
              if (
                (i.spawning &&
                  ((i.lifeDelayTime += t.value),
                  i.lifeDelayTime >= i.lifeDelay &&
                    ((e = !0),
                    (i.spawning = !1),
                    (i.lifeDelayTime = 0),
                    (i.lifeTime = 0))),
                -1 !== i.lifeDuration &&
                  !i.spawning &&
                  (e ? (i.lifeTime = 0) : (i.lifeTime += t.value),
                  i.lifeTime >= i.lifeDuration))
              ) {
                if (
                  ((i.lifeTime = 0),
                  i.livesRemaining > 0 && i.livesRemaining--,
                  0 === i.livesRemaining)
                )
                  return void i.destroy();
                const t = this.container.canvas.size;
                (i.position.x = r.randomInRange(0, t.width)),
                  (i.position.y = r.randomInRange(0, t.height)),
                  (i.spawning = !0),
                  (i.lifeDelayTime = 0),
                  (i.lifeTime = 0);
                const e = i.particlesOptions.life;
                (i.lifeDelay = 1e3 * r.getValue(e.delay)),
                  (i.lifeDuration = 1e3 * r.getValue(e.duration));
              }
            }
            updateOpacity(t) {
              var i, e;
              const o = this.particle,
                s = o.particlesOptions.opacity.anim,
                n = s.minimumValue,
                a = o.particlesOptions.opacity.value;
              if (s.enable) {
                switch (o.opacity.status) {
                  case y.increasing:
                    o.opacity.value >= a
                      ? (o.opacity.status = y.decreasing)
                      : (o.opacity.value +=
                          (null !== (i = o.opacity.velocity) && void 0 !== i
                            ? i
                            : 0) * t.factor);
                    break;
                  case y.decreasing:
                    o.opacity.value <= n
                      ? (o.opacity.status = y.increasing)
                      : (o.opacity.value -=
                          (null !== (e = o.opacity.velocity) && void 0 !== e
                            ? e
                            : 0) * t.factor);
                }
                it(o, s.destroy, o.opacity.value, n, a),
                  o.destroyed ||
                    (o.opacity.value = r.clamp(o.opacity.value, n, a));
              }
            }
            updateSize(t) {
              var i, e;
              const o = this.container,
                s = this.particle,
                n = s.particlesOptions.size.animation,
                a =
                  (null !== (i = s.size.velocity) && void 0 !== i ? i : 0) *
                  t.factor,
                l =
                  null !== (e = s.sizeValue) && void 0 !== e
                    ? e
                    : o.retina.sizeValue,
                c = n.minimumValue * o.retina.pixelRatio;
              if (n.enable) {
                switch (s.size.status) {
                  case y.increasing:
                    s.size.value >= l
                      ? (s.size.status = y.decreasing)
                      : (s.size.value += a);
                    break;
                  case y.decreasing:
                    s.size.value <= c
                      ? (s.size.status = y.increasing)
                      : (s.size.value -= a);
                }
                it(s, n.destroy, s.size.value, c, l),
                  s.destroyed || (s.size.value = r.clamp(s.size.value, c, l));
              }
            }
            updateAngle(t) {
              var i;
              const e = this.particle,
                o = e.particlesOptions.rotate,
                s = o.animation,
                n =
                  (null !== (i = e.rotate.velocity) && void 0 !== i ? i : 0) *
                  t.factor,
                a = 2 * Math.PI;
              if (o.path)
                e.pathAngle = Math.atan2(
                  e.velocity.vertical,
                  e.velocity.horizontal
                );
              else if (s.enable)
                switch (e.rotate.status) {
                  case y.increasing:
                    (e.rotate.value += n),
                      e.rotate.value > a && (e.rotate.value -= a);
                    break;
                  case y.decreasing:
                  default:
                    (e.rotate.value -= n),
                      e.rotate.value < 0 && (e.rotate.value += a);
                }
            }
            updateColor(t) {
              var i;
              const e = this.particle;
              void 0 !== e.color.value &&
                e.particlesOptions.color.animation.enable &&
                ((e.color.value.h +=
                  (null !== (i = e.color.velocity) && void 0 !== i ? i : 0) *
                  t.factor),
                e.color.value.h > 360 && (e.color.value.h -= 360));
            }
            updateStrokeColor(t) {
              var i, e;
              const o = this.particle,
              ...
              "string" != typeof s &&
                void 0 !== s &&
                void 0 !== o.strokeColor.value &&
                s.animation.enable &&
                ((o.strokeColor.value.h +=
                  (null !==
                    (e =
                      null !== (i = o.strokeColor.velocity) && void 0 !== i
                        ? i
                        : o.color.velocity) && void 0 !== e
                    ? e
                    : 0) * t.factor),
                o.strokeColor.value.h > 360 && (o.strokeColor.value.h -= 360));
            }
            updateOutModes(t) {
              var i, e, o, n;
              const a = this.particle.particlesOptions.move.outModes;
              this.updateOutMode(
                t,
                ...
                this.updateOutMode(
                  t,
                  null !== (e = a.left) && void 0 !== e ? e : a.default,
                  s.left
                ),
                this.updateOutMode(
                  t,
            ...
            fixOutOfCanvasPosition(t) {
              const i = this.container,
                e = this.particle,
                o = e.particlesOptions.move.warp,
                n = i.canvas.size,
                a = {
                ...
                r = e.getRadius(),
                l = P.calculateBounds(e.position, r);
              t === s.right && l.left > n.width - e.offset.x
                ? ((e.position.x = a.left),
                  o || (e.position.y = Math.random() * n.height))
                : t === s.left &&
                  l.right < -e.offset.x &&
                  ((e.position.x = a.right),
                  o || (e.position.y = Math.random() * n.height)),
                t === s.bottom && l.top > n.height - e.offset.y
                  ? (o || (e.position.x = Math.random() * n.width),
                    (e.position.y = a.top))
                  : t === s.top &&
                    l.bottom < -e.offset.y &&
                    (o || (e.position.x = Math.random() * n.width),
            ...
            updateBounce(t, i, e) {
              const o = this.container,
                n = this.particle;
              let a = !1;
              for (const [, e] of o.plugins)
                if (
                  (void 0 !== e.particleBounce &&
                    (a = e.particleBounce(n, t, i)),
                  a)
                )
                  break;
              if (a) return;
              const l = n.getPosition(),
                c = n.offset,
                d = n.getRadius(),
                h = P.calculateBounds(l, d),
                v = o.canvas.size;
              !(function (t) {
                if (
                  t.outMode === u.bounce ||
                  t.outMode === u.bounceHorizontal ||
                  "bounceHorizontal" === t.outMode
                ) {
                  const i = t.particle.velocity.horizontal;
                  let e = !1;
                  if (
                    (t.direction === s.right &&
                      t.bounds.right >= t.canvasSize.width &&
                      i > 0) ||
                    (t.direction === s.left && t.bounds.left <= 0 && i < 0)
                  ) {
                    const i = r.getValue(
                      t.particle.particlesOptions.bounce.horizontal
                    );
                    (t.particle.velocity.horizontal *= -i), (e = !0);
                  }
                  if (e) {
                ...
                (function (t) {
                  if (
                    t.outMode === u.bounce ||
                    t.outMode === u.bounceVertical ||
                    "bounceVertical" === t.outMode
                  ) {
                    const i = t.particle.velocity.vertical;
                    let e = !1;
                    if (
                      (t.direction === s.bottom &&
                        t.bounds.bottom >= t.canvasSize.height &&
                        i > 0) ||
                      (t.direction === s.top && t.bounds.top <= 0 && i < 0)
                    ) {
                      const i = r.getValue(
                        t.particle.particlesOptions.bounce.vertical
                      );
                      (t.particle.velocity.vertical *= -i), (e = !0);
                    }
                    if (e) {
            ...
            bounceNone(t) {
              const i = this.particle;
              if (i.particlesOptions.move.distance) return;
              const e = i.particlesOptions.move.gravity,
                o = this.container;
              if (e.enable) {
                const n = i.position;
                ((e.acceleration >= 0 &&
                  n.y > o.canvas.size.height &&
                  t === s.bottom) ||
                  (e.acceleration < 0 && n.y < 0 && t === s.top)) &&
                  o.particles.remove(i);
              } else
                P.isPointInside(i.position, o.canvas.size, i.getRadius(), t) ||
                  o.particles.remove(i);
            }
          }
          class ot {
            ...
            static create(t, i) {
              ...
              return (
                void 0 !== i && e.load("string" == typeof i ? { value: i } : i),
                e
              );
            }
            load(t) {
          ...
          class st {
            ...
            load(t) {
              void 0 !== t &&
                ...
                (this.color = ot.create(this.color, t.color)),
          ...
          class rt {
            ...
            load(t) {
              ...
              const n =
                null !==
                  (e =
                    null === (i = t.rotate) || void 0 === i ? void 0 : i.x) &&
                void 0 !== e
                  ? e
                  : t.rotateX;
              ...
              const a =
                null !==
                  (s =
                    null === (o = t.rotate) || void 0 === o ? void 0 : o.y) &&
                void 0 !== s
                  ? s
                  : t.rotateY;
          ...
          class lt {
            constructor() {
              (this.enable = !1),
                (this.length = 10),
                (this.fillColor = new ot()),
                (this.fillColor.value = "#000000");
            }
            load(t) {
              void 0 !== t &&
                (void 0 !== t.enable && (this.enable = t.enable),
                (this.fillColor = ot.create(this.fillColor, t.fillColor)),
          ...
          class ut {
            constructor() {
              (this.delay = new ht()), (this.enable = !1);
            }
            load(t) {
              void 0 !== t &&
          ...
          class yt {
            ...
            load(t) {
              ...
              t &&
                ...
                (this.left =
                  null !== (e = t.left) && void 0 !== e ? e : t.default),
                (this.right =
                  null !== (o = t.right) && void 0 !== o ? o : t.default),
                (this.top =
                  null !== (s = t.top) && void 0 !== s ? s : t.default));
            }
          }
          class ft {
            constructor() {
              (this.angle = new vt()),
                (this.attract = new rt()),
                (this.direction = n.none),
                (this.distance = 0),
                (this.enable = !1),
                (this.gravity = new pt()),
                (this.noise = new ut()),
                (this.outModes = new yt()),
                (this.random = !1),
                (this.size = !1),
                (this.speed = 2),
                (this.straight = !1),
            ...
            load(t) {
              ...
              const o =
                null !== (i = t.outMode) && void 0 !== i ? i : t.out_mode;
              (void 0 === t.outModes && void 0 === o) ||
                ("string" == typeof t.outModes ||
                (void 0 === t.outModes && void 0 !== o)
                  ? this.outModes.load({
                      default:
                        null !== (e = t.outModes) && void 0 !== e ? e : o,
                    })
          ...
          class mt {
            ...
            load(t) {
              ...
              void 0 !== t.enable && (this.enable = t.enable);
              const e =
                null !== (i = t.area) && void 0 !== i ? i : t.value_area;
          ...
          class gt {
            constructor() {
              (this.density = new mt()), (this.limit = 0), (this.value = 100);
            }
            get max() {
              return this.limit;
            }
          ...
          class bt {
            ...
            load(t) {
              ...
              void 0 !== t.destroy && (this.destroy = t.destroy),
                void 0 !== t.enable && (this.enable = t.enable);
              const e =
                null !== (i = t.minimumValue) && void 0 !== i
                  ? i
                  : t.opacity_min;
          ...
          class wt extends dt {
            ...
            load(t) {
              ...
              t &&
                (super.load(t),
                this.animation.load(
                  null !== (i = t.animation) && void 0 !== i ? i : t.anim
                ));
            }
          }
          class xt {
            constructor() {
              (this.options = {}), (this.type = g.circle);
            }
            get image() {
              var t;
              return null !== (t = this.options[g.image]) && void 0 !== t
                ? t
                : this.options[g.images];
            }
            set image(t) {
              (this.options[g.image] = t), (this.options[g.images] = t);
            }
            get custom() {
              return this.options;
            }
            ...
            get character() {
              var t;
              return null !== (t = this.options[g.character]) && void 0 !== t
                ? t
                : this.options[g.char];
            }
            set character(t) {
              (this.options[g.character] = t), (this.options[g.char] = t);
            }
            get polygon() {
              var t;
              return null !== (t = this.options[g.polygon]) && void 0 !== t
                ? t
                : this.options[g.star];
            }
            set polygon(t) {
              (this.options[g.polygon] = t), (this.options[g.star] = t);
            }
            load(t) {
              var i, e, o;
              if (void 0 === t) return;
              ...
              if (void 0 !== s)
                for (const t in s) {
                  const i = s[t];
                  void 0 !== i &&
                    (this.options[t] = P.deepExtend(
                      null !== (e = this.options[t]) && void 0 !== e ? e : {},
                      i
                    ));
                }
              this.loadShape(t.character, g.character, g.char, !0),
                this.loadShape(t.polygon, g.polygon, g.star, !1),
                this.loadShape(
              ...
              void 0 !== t &&
                (t instanceof Array
                  ? (this.options[i] instanceof Array ||
                    ...
                    (this.options[i] = P.deepExtend(
                      null !== (s = this.options[i]) && void 0 !== s ? s : [],
                      t
                    )),
                    (this.options[e] && !o) ||
                      (this.options[e] = P.deepExtend(
          ...
          class Et {
            constructor() {
              (this.horizontal = new Tt()), (this.vertical = new Tt());
            }
            load(t) {
              t &&
            ...
            load(t) {
              ...
              void 0 !== d &&
                (d instanceof Array
                  ...
                  : (this.stroke instanceof Array && (this.stroke = new At()),
                    this.stroke.load(d)));
            }
          }
          class qt {
            ...
            startInfection(t) {
              t > this.container.options.infection.stages.length ||
                t < 0 ||
            ...
            updateInfection(t) {
              ...
              if (
                ...
                if (i > s || i < 0) return;
                this.infectionDelay > 1e3 * e.delay
                  ? ((this.infectionStage = i),
              ...
              if (
                ...
                void 0 !== this.infectionTime
              ) {
                const i = o[this.infectionStage];
                void 0 !== i.duration &&
                i.duration >= 0 &&
                this.infectionTime > 1e3 * i.duration
            ...
            nextInfectionStage() {
              ...
              if (
                !(i <= 0 || void 0 === this.infectionStage) &&
                ((this.infectionTime = 0), i <= ++this.infectionStage)
              ) {
                if (t.infection.cure)
                  return (
                    delete this.infectionStage, void delete this.infectionTime
                  );
          ...
          class _t {
            ...
            moveParticle(t) {
              var i, e;
              const o = this.particle,
                s = o.particlesOptions;
              if (!s.move.enable) return;
              const n = this.container,
                a = this.getProximitySpeedFactor(),
                l =
                  (null !== (i = o.moveSpeed) && void 0 !== i
                    ? i
                    : n.retina.moveSpeed) * n.retina.reduceFactor,
                c =
                  null !== (e = o.sizeValue) && void 0 !== e
                    ? e
                    : n.retina.sizeValue,
                d =
                  (l / 2) *
                  (s.move.size ? o.getRadius() / c : 1) *
                  a *
                  t.factor;
              this.applyNoise(t);
              const h = s.move.gravity;
              h.enable &&
                (o.velocity.vertical += (h.acceleration * t.factor) / (60 * d));
              const u = {
                horizontal: o.velocity.horizontal * d,
                vertical: o.velocity.vertical * d,
              };
              h.enable &&
                u.vertical >= h.maxSpeed &&
                h.maxSpeed > 0 &&
                ((u.vertical = h.maxSpeed),
                (o.velocity.vertical = u.vertical / d)),
                (o.position.x += u.horizontal),
                (o.position.y += u.vertical),
                s.move.vibrate &&
                  ((o.position.x += Math.sin(
                    o.position.x * Math.cos(o.position.y)
                  )),
                  (o.position.y += Math.cos(
                    o.position.y * Math.sin(o.position.x)
                  )));
              const v = o.initialPosition,
                p = r.getDistance(v, o.position);
              o.maxDistance &&
                (p >= o.maxDistance && !o.misplaced
                  ? ((o.misplaced = p > o.maxDistance),
                    (o.velocity.horizontal =
                      o.velocity.vertical / 2 - o.velocity.horizontal),
                    (o.velocity.vertical =
                      o.velocity.horizontal / 2 - o.velocity.vertical))
                  : p < o.maxDistance && o.misplaced
                  ? (o.misplaced = !1)
                  : o.misplaced &&
                    (((o.position.x < v.x && o.velocity.horizontal < 0) ||
                      (o.position.x > v.x && o.velocity.horizontal > 0)) &&
                      (o.velocity.horizontal *= -Math.random()),
                    ((o.position.y < v.y && o.velocity.vertical < 0) ||
                      (o.position.y > v.y && o.velocity.vertical > 0)) &&
                      (o.velocity.vertical *= -Math.random())));
            }
            applyNoise(t) {
              const i = this.particle;
              ...
              if (i.lastNoiseTime <= i.noiseDelay)
                return void (i.lastNoiseTime += t.value);
              const o = e.noise.generate(i);
              (i.velocity.horizontal += Math.cos(o.angle) * o.length),
                (i.velocity.horizontal = r.clamp(i.velocity.horizontal, -1, 1)),
                (i.velocity.vertical += Math.sin(o.angle) * o.length),
                (i.velocity.vertical = r.clamp(i.velocity.vertical, -1, 1)),
                (i.lastNoiseTime -= i.noiseDelay);
            }
            moveParallax() {
              const t = this.container,
                i = t.options;
              if (P.isSsr() || !i.interactivity.events.onHover.parallax.enable)
                return;
              const e = this.particle,
              ...
              const n = t.canvas.size.width / 2,
                ...
                c = (s.x - n) * l,
                d = (s.y - a) * l;
              (e.offset.x += (c - e.offset.x) / r),
                (e.offset.y += (d - e.offset.y) / r);
            }
            getProximitySpeedFactor() {
              const t = this.container,
                i = t.options;
              if (!P.isInArray(d.slow, i.interactivity.events.onHover.mode))
                return 1;
          ...
          class Bt {
            constructor(t, i, e, o) {
              ...
              const f = i.retina.pixelRatio,
                ...
                g = new Vt();
              g.load(m.particles);
              const w = g.shape.type,
                x = g.reduceDuplicates;
              if (
                ((this.shape =
                  w instanceof Array ? P.itemFromArray(w, this.id, x) : w),
                null == o ? void 0 : o.shape)
              ) {
                if (o.shape.type) {
                  const t = o.shape.type;
                  this.shape =
                    t instanceof Array ? P.itemFromArray(t, this.id, x) : t;
                }
                const t = new xt();
                if ((t.load(o.shape), this.shape)) {
                  const i = t.options[this.shape];
                  i &&
                    (this.shapeData = P.deepExtend(
                      {},
                      i instanceof Array ? P.itemFromArray(i, this.id, x) : i
                    ));
                }
              } else {
                const t = g.shape.options[this.shape];
                t &&
                  (this.shapeData = P.deepExtend(
                    {},
                    t instanceof Array ? P.itemFromArray(t, this.id, x) : t
              ...
              void 0 !== o && g.load(o),
                void 0 !==
                  (null === (s = this.shapeData) || void 0 === s
                    ? void 0
                    : s.particles) &&
                  g.load(
                ...
                (this.close =
                  null !==
                    (h =
                      null === (d = this.shapeData) || void 0 === d
                        ? void 0
                        : d.close) && void 0 !== h
                    ? h
                    : this.close),
                ...
                (this.noiseDelay =
                  1e3 * r.getValue(this.particlesOptions.move.noise.delay)),
                i.retina.initParticle(this);
              const k = this.particlesOptions.color,
                z = this.particlesOptions.size,
                M = r.getValue(z) * i.retina.pixelRatio,
                S = "boolean" == typeof z.random ? z.random : z.random.enable;
              (this.size = { value: M }),
              ...
              const R = this.particlesOptions.rotate;
              this.rotate = {
                value:
                  ((R.random.enable ? 360 * Math.random() : R.value) *
                    Math.PI) /
                  180,
              };
              let C = R.direction;
              ...
              T.enable &&
                ((this.rotate.velocity =
                  (T.speed / 360) * i.retina.reduceFactor),
                T.sync || (this.rotate.velocity *= Math.random()));
              const E = this.particlesOptions.size.animation;
              if (E.enable) {
                if (((this.size.status = y.increasing), !S))
                  switch (E.startValue) {
                    case b.min:
                      this.size.value = E.minimumValue * f;
                      break;
                    case b.random:
                      this.size.value = r.randomInRange(
                        E.minimumValue * f,
                        this.size.value
                      );
                      break;
                    case b.max:
                    default:
                      this.size.status = y.decreasing;
                  }
                (this.size.velocity =
                  ((null !== (u = this.sizeAnimationSpeed) && void 0 !== u
                    ? u
              ...
              this.color = { value: A.colorToHsl(k, this.id, x) };
              const O = this.particlesOptions.color.animation;
              O.enable &&
                ((this.color.velocity =
                  (O.speed / 100) * i.retina.reduceFactor),
                O.sync || (this.color.velocity *= Math.random())),
                ...
                (this.offset = { x: 0, y: 0 });
              const D = this.particlesOptions.opacity,
                I = "boolean" == typeof D.random ? D.random : D.random.enable;
              this.opacity = { value: r.getValue(D) };
              const L = D.animation;
              if (L.enable) {
                if (((this.opacity.status = y.increasing), !I))
                  switch (L.startValue) {
                    case b.min:
                      this.opacity.value = L.minimumValue;
                      break;
                    case b.random:
                      this.opacity.value = r.randomInRange(
                        L.minimumValue,
                        this.opacity.value
                      );
                      break;
                    case b.max:
                    default:
                      this.opacity.status = y.decreasing;
                  }
                (this.opacity.velocity =
                  (L.speed / 100) * i.retina.reduceFactor),
                  L.sync || (this.opacity.velocity *= Math.random());
              }
              this.sides = 24;
              let H = i.drawers.get(this.shape);
              H ||
                ((H = B.getShapeDrawer(this.shape)),
                H && i.drawers.set(this.shape, H));
              const F = null == H ? void 0 : H.getSidesCount;
              F && (this.sides = F(this));
              const V = this.loadImageShape(i, H);
              if (
                (V &&
                  ((this.image = V.image),
                  (this.fill = V.fill),
                ...
                (this.stroke =
                  this.particlesOptions.stroke instanceof Array
                    ? P.itemFromArray(this.particlesOptions.stroke, this.id, x)
                    : this.particlesOptions.stroke),
                (this.strokeWidth = this.stroke.width * i.retina.pixelRatio),
                (this.strokeColor = {
                  value:
                    null !== (v = A.colorToHsl(this.stroke.color)) &&
                    void 0 !== v
                      ? v
                      : this.color.value,
                }),
                "string" != typeof this.stroke.color)
              ) {
                const t =
                  null === (p = this.stroke.color) || void 0 === p
                    ? void 0
                    : p.animation;
                t &&
                  this.strokeColor &&
                  (t.enable
                    ? ((this.strokeColor.velocity =
                        (t.speed / 100) * i.retina.reduceFactor),
                      t.sync ||
                        (this.strokeColor.velocity =
                          this.strokeColor.velocity * Math.random()))
                    : (this.strokeColor.velocity = 0),
                  t.enable &&
                    !t.sync &&
                    this.strokeColor.value &&
                    (this.strokeColor.value.h = 360 * Math.random()));
              }
              const q = g.life;
              (this.lifeDelay = i.retina.reduceFactor
                ? ((r.getValue(q.delay) * (q.delay.sync ? 1 : Math.random())) /
                    i.retina.reduceFactor) *
                  1e3
                : 0),
                (this.lifeDelayTime = 0),
                (this.lifeDuration = i.retina.reduceFactor
                  ? ((r.getValue(q.duration) *
                      (q.duration.sync ? 1 : Math.random())) /
                      i.retina.reduceFactor) *
                    1e3
                  : 0),
                (this.lifeTime = 0),
                (this.livesRemaining = g.life.count),
                (this.spawning = this.lifeDelay > 0),
                this.lifeDuration <= 0 && (this.lifeDuration = -1),
                this.livesRemaining <= 0 && (this.livesRemaining = -1),
                (this.shadowColor = A.colorToRgb(
                  this.particlesOptions.shadow.color
                )),
                (this.updater = new et(i, this)),
                (this.infecter = new qt(i)),
                (this.mover = new _t(i, this));
            }
            move(t) {
              this.mover.move(t);
            }
            ...
            getFillColor() {
              var t;
              return null !== (t = this.bubble.color) && void 0 !== t
                ? t
                : this.color.value;
            }
            getStrokeColor() {
              ...
              return null !==
                (i =
                  null !== (t = this.bubble.color) && void 0 !== t
                    ? t
                    : this.strokeColor.value) && void 0 !== i
                ? i
                : this.color.value;
            }
            destroy() {
            ...
            calcPosition(t, i) {
              ...
              for (const [, e] of t.plugins) {
                const t =
                  void 0 !== e.particlePosition
                    ? e.particlePosition(i, this)
                    : void 0;
                if (void 0 !== t) return P.deepExtend({}, t);
              }
              const s = {
                  x:
                    null !== (e = null == i ? void 0 : i.x) && void 0 !== e
                      ? e
                      : Math.random() * t.canvas.size.width,
                  y:
                    null !== (o = null == i ? void 0 : i.y) && void 0 !== o
                      ? o
                      : Math.random() * t.canvas.size.height,
                },
                n = this.particlesOptions.move.outMode;
              return (
                (P.isInArray(n, u.bounce) ||
                  P.isInArray(n, u.bounceHorizontal)) &&
                  (s.x > t.canvas.size.width - 2 * this.size.value
                    ? (s.x -= this.size.value)
                    : s.x < 2 * this.size.value && (s.x += this.size.value)),
                (P.isInArray(n, u.bounce) ||
                  P.isInArray(n, u.bounceVertical)) &&
                  (s.y > t.canvas.size.height - 2 * this.size.value
                    ? (s.y -= this.size.value)
                    : s.y < 2 * this.size.value && (s.y += this.size.value)),
                s
              );
            }
            calculateVelocity() {
              const t = r.getParticleBaseVelocity(this),
                i = { horizontal: 0, vertical: 0 },
                e = this.particlesOptions.move;
              let o,
                s = Math.PI / 4;
              "number" == typeof e.angle
                ? (o = (Math.PI / 180) * e.angle)
                : ((o = (Math.PI / 180) * e.angle.value),
                  (s = (Math.PI / 180) * e.angle.offset));
              const n = {
                left: Math.sin(s + o / 2) - Math.sin(s - o / 2),
                right: Math.cos(s + o / 2) - Math.cos(s - o / 2),
              };
              return (
                e.straight
                  ? ((i.horizontal = t.x),
                    (i.vertical = t.y),
                    e.random &&
                      ((i.horizontal += r.randomInRange(n.left, n.right) / 2),
                      (i.vertical += r.randomInRange(n.left, n.right) / 2)))
                  : ((i.horizontal =
                      t.x + r.randomInRange(n.left, n.right) / 2),
                    (i.vertical = t.y + r.randomInRange(n.left, n.right) / 2)),
                i
              );
            }
            loadImageShape(t, i) {
              var e, o, s, n, a;
              if (this.shape !== g.image && this.shape !== g.images) return;
              const r = i.getImages(t).images,
                l = this.shapeData,
                c =
                  null !== (e = r.find((t) => t.source === l.src)) &&
                  void 0 !== e
                    ? e
                    : r[0],
                d = this.getFillColor();
              ...
              if (void 0 !== c.svgData && l.replaceColor && d) {
                const t = A.replaceColorSvg(c, d, this.opacity.value),
                  i = new Blob([t], { type: "image/svg+xml" }),
                ...
                (h = {
                  ...
                  replaceColor:
                    null !== (o = l.replaceColor) && void 0 !== o
                      ? o
                      : l.replace_color,
                  source: l.src,
                }),
                  n.addEventListener("load", () => {
                    this.image && ((this.image.loaded = !0), (c.element = n)),
                      e.revokeObjectURL(s);
                  }),
                  n.addEventListener("error", () => {
                    e.revokeObjectURL(s),
                      P.loadImage(l.src).then((t) => {
                        this.image &&
                          ((c.element = t.element), (this.image.loaded = !0));
                      });
                  }),
                  (n.src = s);
              } else
                h = {
                  ...
                  ratio: l.width / l.height,
                  replaceColor:
                    null !== (s = l.replaceColor) && void 0 !== s
                      ? s
                      : l.replace_color,
                  source: l.src,
                };
          ...
          class Nt {
            ...
            isEnabled() {
              ...
              return P.isInArray(d.grab, o);
            }
            reset() {}
            interact() {
              var t;
              const i = this.container,
                e = i.options.interactivity;
              if (
                e.events.onHover.enable &&
                i.interactivity.status === S.mouseMoveEvent
              ) {
                ...
                for (const a of n) {
                  ...
                  if (l <= s) {
                    ...
                    if (c > 0) {
                      const e =
                        null !== (t = n.color) && void 0 !== t
                          ? t
                          : a.particlesOptions.links.color;
                      if (!i.particles.grabLineColor) {
                        const t = i.options.interactivity.modes.grab.links;
                        i.particles.grabLineColor = A.getLinkRandomColor(
                          e,
                          t.blink,
                          t.consent
                        );
                      }
                      const s = A.getLinkColor(
                        a,
                        void 0,
                        i.particles.grabLineColor
                      );
                      if (void 0 === s) return;
          ...
          class Wt {
            ...
            isEnabled() {
              const t = this.container,
                ...
                s = o.onDiv,
                n = P.isDivModeEnabled(c.repulse, s);
              if (
                !(
                  n ||
              ...
              const a = o.onHover.mode,
                r = o.onClick.mode;
              return (
                P.isInArray(d.repulse, a) || P.isInArray(l.repulse, r) || n
              );
            }
            reset() {}
            interact() {
              const t = this.container,
                i = t.options,
                e = t.interactivity.status === S.mouseMoveEvent,
                o = i.interactivity.events,
                s = o.onHover.enable,
                n = o.onHover.mode,
                a = o.onClick.enable,
                r = o.onClick.mode,
                h = o.onDiv;
              e && s && P.isInArray(d.repulse, n)
                ? this.hoverRepulse()
                : a && P.isInArray(l.repulse, r)
                ? this.clickRepulse()
                : P.divModeExecute(c.repulse, h, (t, i) =>
                    this.singleSelectorRepulse(t, i)
                  );
            }
            ...
            hoverRepulse() {
              ...
              this.processRepulse(i, e, new D(i.x, i.y, e));
            }
            processRepulse(t, i, e, o) {
              ...
              for (const e of a) {
                const {
                    ...
                    dy: l,
                    distance: c,
                  } = r.getDistances(e.position, t),
                  d = { x: a / c, y: l / c },
                  h =
                    100 *
                    (null !== (s = null == o ? void 0 : o.speed) && void 0 !== s
                      ? s
                      : n.options.interactivity.modes.repulse.speed),
                  u = r.clamp((1 - Math.pow(c / i, 2)) * h, 0, 50);
                (e.position.x = e.position.x + d.x * u),
                  (e.position.y = e.position.y + d.y * u);
              }
            }
            clickRepulse() {
              const t = this.container;
              if (
                (t.repulse.finish ||
                  ...
                  t.repulse.count++,
                  t.repulse.count === t.particles.count &&
                    (t.repulse.finish = !0)),
                t.repulse.clicking)
              ) {
                ...
                for (const i of n) {
                  const {
                      ...
                      dy: n,
                      distance: a,
                    } = r.getDistances(o, i.position),
                    l = a * a,
                    c = t.options.interactivity.modes.repulse.speed,
                    d = (-e * c) / l;
                  if (l <= e) {
                    t.repulse.particles.push(i);
                    const e = Math.atan2(n, s);
                    (i.velocity.horizontal = d * Math.cos(e)),
                      (i.velocity.vertical = d * Math.sin(e));
                  }
                }
          ...
          class Gt {
            ...
            isEnabled() {
              const t = this.container,
                ...
                o = i.interactivity.events,
                s = o.onDiv,
                n = P.isDivModeEnabled(c.bubble, s);
              if (
                !(
                  n ||
                  (o.onHover.enable && e.position) ||
              ...
              const a = o.onHover.mode,
                r = o.onClick.mode;
              return P.isInArray(d.bubble, a) || P.isInArray(l.bubble, r) || n;
            }
            reset(t, i) {
              (t.bubble.inRange && !i) ||
                (delete t.bubble.div,
            ...
            interact() {
              const t = this.container.options.interactivity.events,
                ...
                a = e.mode,
                r = t.onDiv;
              o && P.isInArray(d.bubble, s)
                ? this.hoverBubble()
                : n && P.isInArray(l.bubble, a)
                ? this.clickBubble()
                : P.divModeExecute(c.bubble, r, (t, i) =>
                    this.singleSelectorHover(t, i)
                  );
            }
              ...
              o.length &&
                o.forEach((t) => {
                  ...
                  for (const t of l) {
                    ...
                    t.bubble.inRange = !0;
                    const i = e.options.interactivity.modes.bubble.divs,
                      s = P.divMode(i, o);
            ...
            process(t, i, e, o) {
              ...
              if (void 0 === n) return;
              const a = s.options.interactivity.modes.bubble.duration,
              ...
              if (n !== l)
                if (s.bubble.durationEnd)
                  c &&
                    (h === m.size && delete t.bubble.radius,
                    h === m.opacity && delete t.bubble.opacity);
                else if (i <= r) {
                  if ((null != c ? c : d) !== n) {
                    const i = d - (e * (d - n)) / a;
                    h === m.size && (t.bubble.radius = i),
                      h === m.opacity && (t.bubble.opacity = i);
                  }
                } else
                  h === m.size && delete t.bubble.radius,
                    h === m.opacity && delete t.bubble.opacity;
            ...
            clickBubble() {
              ...
              for (const s of n) {
                ...
                this.process(s, a, l, d),
                  i.bubble.durationEnd
                    ? delete s.bubble.color
                    : a <= i.retina.bubbleModeDistance
                    ? this.hoverBubbleColor(s)
                    : delete s.bubble.color;
              }
            }
            hoverBubble() {
              ...
              for (const s of o) {
                ...
                n <= e
                  ? a >= 0 &&
                    t.interactivity.status === S.mouseMoveEvent &&
                    (this.hoverBubbleSize(s, a),
                    this.hoverBubbleOpacity(s, a),
                    this.hoverBubbleColor(s))
                  : this.reset(s),
                  t.interactivity.status === S.mouseLeaveEvent && this.reset(s);
              }
            }
            hoverBubbleSize(t, i, e) {
              ...
              const s = this.container,
                n = (null == e ? void 0 : e.size)
                  ? e.size * s.retina.pixelRatio
                  : s.retina.bubbleModeSize;
              if (void 0 === n) return;
              const a =
                  null !== (o = t.sizeValue) && void 0 !== o
                    ? o
                    : s.retina.sizeValue,
                r = Ut(t.size.value, n, a, i);
              void 0 !== r && (t.bubble.radius = r);
            }
            ...
            hoverBubbleColor(t, i) {
              ...
              if (void 0 === t.bubble.color) {
                const s =
                  null !== (e = null == i ? void 0 : i.color) && void 0 !== e
                    ? e
                    : o.interactivity.modes.bubble.color;
                if (void 0 === s) return;
                const n = s instanceof Array ? P.itemFromArray(s) : s;
                t.bubble.color = A.colorToHsl(n);
              }
            }
          }
          class $t {
            ...
            isEnabled() {
              ...
              if (!e.onHover.enable || !i.position) return !1;
              const o = e.onHover.mode;
              return P.isInArray(d.connect, o);
            }
            reset() {}
            interact() {
              const t = this.container;
              if (
                t.options.interactivity.events.onHover.enable &&
          ...
          class jt {
            ...
            interact(t) {
              var i;
              const e = this.container,
                o = t.particlesOptions.links,
                s = o.opacity,
                n =
                  null !== (i = t.linksDistance) && void 0 !== i
                    ? i
                    : e.retina.linksDistance,
                a = e.canvas.size,
                l = o.warp,
                c = t.getPosition(),
                d = l ? new L(c.x, c.y, n, a) : new D(c.x, c.y, n),
                h = e.particles.quadTree.query(d);
              for (const i of h) {
                const d = i.particlesOptions.links;
                if (
                  t === i ||
                  !d.enable ||
                  o.id !== d.id ||
                ...
                if (l && u > n) {
                  const t = { x: h.x - a.width, y: h.y };
                  if (((u = r.getDistance(c, t)), u > n)) {
                    const t = { x: h.x - a.width, y: h.y - a.height };
                    if (((u = r.getDistance(c, t)), u > n)) {
                      const t = { x: h.x, y: h.y - a.height };
                      u = r.getDistance(c, t);
                    }
                  }
                }
                if (u > n) return;
                const v = (1 - u / n) * s,
                  p = t.particlesOptions.links;
                let y =
                  void 0 !== p.id
                    ? e.particles.linksColors.get(p.id)
                    : e.particles.linksColor;
                if (!y) {
                  const t = p.color;
                  (y = A.getLinkRandomColor(t, p.blink, p.consent)),
                    void 0 !== p.id
                      ? e.particles.linksColors.set(p.id, y)
                      : (e.particles.linksColor = y);
                }
                -1 === i.links.map((t) => t.destination).indexOf(t) &&
                  -1 === t.links.map((t) => t.destination).indexOf(i) &&
                  t.links.push({ destination: i, opacity: v });
              }
            }
          }
          class Xt {
            ...
            interact(t) {
              ...
              for (const i of n) {
                if (
                  t === i ||
                  !i.particlesOptions.move.attract.enable ||
                  i.destroyed ||
                  i.spawning
                )
                  continue;
                const e = i.getPosition(),
                  { dx: o, dy: n } = r.getDistances(s, e),
                  a = t.particlesOptions.move.attract.rotate,
                  l = o / (1e3 * a.x),
                  c = n / (1e3 * a.y);
          ...
          class Yt {
            ...
            interact(t) {
              ...
              for (const i of o) {
                if (
                  t === i ||
                  !i.particlesOptions.collisions.enable ||
                  t.particlesOptions.collisions.mode !==
                    i.particlesOptions.collisions.mode ||
                  i.destroyed ||
                  i.spawning
                )
                  continue;
                const o = i.getPosition();
                r.getDistance(e, o) <= t.getRadius() + i.getRadius() &&
                  this.resolveCollision(t, i);
              }
            }
            resolveCollision(t, i) {
              switch (t.particlesOptions.collisions.mode) {
                ...
                case h.bounce:
                  !(function (t, i) {
                    P.circleBounce(
                      P.circleBounceDataFromParticle(t),
                      P.circleBounceDataFromParticle(i)
                    );
                  })(t, i);
                  break;
                case h.destroy:
            ...
            absorb(t, i) {
              const e = this.container,
                o = e.options.fpsLimit / 1e3;
              if (void 0 === t.getRadius() && void 0 !== i.getRadius())
                t.destroy();
                ...
                if (t.getRadius() >= i.getRadius()) {
                  const s =
                    r.clamp(t.getRadius() / i.getRadius(), 0, i.getRadius()) *
                    o;
                  (t.size.value += s),
                    (i.size.value -= s),
                  ...
                  const s =
                    r.clamp(i.getRadius() / t.getRadius(), 0, t.getRadius()) *
                    o;
                  (t.size.value -= s),
                    (i.size.value += s),
          ...
          class Jt {
            ...
            interact(t, i) {
              var e, o;
              const s = t.infecter;
              if ((s.updateInfection(i.value), void 0 === s.infectionStage))
                return;
              const n = this.container,
                a = n.options.infection;
              ...
              const r = a.stages[s.infectionStage],
                ...
                d = t.getPosition(),
                h =
                  null !== (e = r.infectedStage) && void 0 !== e
                    ? e
                    : s.infectionStage,
              ...
              for (const i of u) {
                if (
                  ...
                  i.destroyed ||
                  i.spawning ||
                  (void 0 !== i.infecter.infectionStage &&
                    i.infecter.infectionStage === s.infectionStage)
                )
                  continue;
                const e = i.infecter;
                if (Math.random() < v / p)
          ...
          class Qt {
            ...
            interact(t) {
              ...
              const i = this.container,
                e = i.options.interactivity.modes.trail,
            ...
            isEnabled() {
              ...
              return (
                (e.clicking &&
                  e.inside &&
                  !!e.position &&
                  P.isInArray(l.trail, o.onClick.mode)) ||
                (e.inside &&
                  !!e.position &&
                  P.isInArray(d.trail, o.onHover.mode))
              );
            }
            reset() {}
          }
          class Zt {
            ...
            isEnabled() {
              ...
              const s = o.onHover.mode,
                n = o.onClick.mode;
              return P.isInArray(d.attract, s) || P.isInArray(l.attract, n);
            }
            reset() {}
            interact() {
              const t = this.container,
                ...
                a = o.onClick.enable,
                r = o.onClick.mode;
              e && s && P.isInArray(d.attract, n)
                ? this.hoverAttract()
                : a && P.isInArray(l.attract, r) && this.clickAttract();
            }
            hoverAttract() {
              const t = this.container,
                i = t.interactivity.mouse.position;
              ...
              this.processAttract(i, e, new D(i.x, i.y, e));
            }
            processAttract(t, i, e) {
              ...
              for (const e of s) {
                const {
                  ...
                  l = { x: s / a, y: n / a },
                  c = o.options.interactivity.modes.attract.speed,
                  d = r.clamp((1 - Math.pow(a / i, 2)) * c, 0, 50);
                (e.position.x = e.position.x - l.x * d),
                  (e.position.y = e.position.y - l.y * d);
              }
            }
            clickAttract() {
              const t = this.container;
          ...
          class Kt {
            ...
            interact(t) {
              const i = this.container;
              if (
                i.options.interactivity.events.onHover.enable &&
          ...
          class ii {
            ...
            isEnabled() {
              ...
              return (
                (e.position &&
                  o.onHover.enable &&
                  P.isInArray(d.bounce, o.onHover.mode)) ||
                P.isDivModeEnabled(c.bounce, s)
              );
            }
            interact() {
              const t = this.container,
                i = t.options.interactivity.events,
                e = t.interactivity.status === S.mouseMoveEvent,
                o = i.onHover.enable,
                s = i.onHover.mode,
                n = i.onDiv;
              e && o && P.isInArray(d.bounce, s)
                ? this.processMouseBounce()
                : P.divModeExecute(c.bounce, n, (t, i) =>
                    this.singleSelectorBounce(t, i)
                  );
            }
            reset() {}
            processMouseBounce() {
              ...
              e && this.processBounce(e, o, new D(e.x, e.y, o + i));
            }
            ...
            processBounce(t, i, e) {
              ...
              for (const s of o)
                e instanceof D
                  ? P.circleBounce(P.circleBounceDataFromParticle(s), {
                      position: t,
                      radius: i,
                      velocity: { horizontal: 0, vertical: 0 },
                      factor: { horizontal: 0, vertical: 0 },
                    })
                  : e instanceof I && P.rectBounce(s, P.calculateBounds(t, i));
            }
          }
          class ei {
            constructor(t) {
          ...
          class oi {
            constructor(t) {
              (this.container = t),
                ...
                (this.interactionManager = new ei(t));
            ...
            init() {
              ...
              if (i.infection.enable)
                for (let t = 0; t < i.infection.infections; t++) {
                  ...
                  P.itemFromArray(t).infecter.startInfection(0);
                }
            ...
            update(t) {
              const i = [];
              this.container.noise.update();
              for (const e of this.array)
                e.move(t),
                  e.destroyed
                    ? i.push(e)
                    : this.quadTree.insert(new N(e.getPosition(), e));
              ...
              for (const i of this.container.particles.array)
                i.update(t),
                  i.destroyed ||
                    i.spawning ||
                    this.interactionManager.particlesInteract(i, t);
            }
            draw(t) {
              const i = this.container;
              i.canvas.clear();
            ...
            push(t, i, e) {
              const o = this.container,
                s = o.options.particles.number.limit * o.density;
              if (((this.pushing = !0), s > 0)) {
                const i = this.count + t - s;
                i > 0 && this.removeQuantity(i);
              }
              for (let o = 0; o < t; o++)
                this.addParticle(null == i ? void 0 : i.position, e);
              this.pushing = !1;
            }
            addParticle(t, i) {
              try {
                const e = new Bt(this.nextId, this.container, t, i);
                return this.array.push(e), this.nextId++, e;
              } catch (t) {
                return void console.warn("error adding particle");
              }
            }
            removeQuantity(t) {
              this.removeAt(0, t);
            ...
            getLinkFrequency(t, i) {
              ...
              return (
                void 0 === o && ((o = Math.random()), this.linksFreq.set(e, o)),
                o
              );
            }
            getTriangleFrequency(t, i, e) {
              ...
              return (
                void 0 === r &&
                  ((r = Math.random()), this.trianglesFreq.set(a, r)),
                r
              );
            }
            setDensity() {
            ...
            applyDensity(t) {
              var i;
              if (
                !(null === (i = t.number.density) || void 0 === i
                  ? void 0
                  : i.enable)
              )
                return;
              const e = t.number,
                ...
                a = Math.min(s, n) * o,
                r = this.count;
              (this.limit = e.limit * o),
                r < a
                  ? this.push(Math.abs(a - r), void 0, t)
                  : r > a && this.removeQuantity(r - a);
            }
            initDensityFactor(t) {
              const i = this.container;
          ...
          class si {
            ...
            init() {
              const t = this.container,
                i = t.options;
              i.detectRetina
                ? (this.pixelRatio = P.isSsr() ? 1 : window.devicePixelRatio)
                : (this.pixelRatio = 1);
              const e = this.container.options.motion;
              ...
              (this.linksDistance = s.links.distance * o),
                ...
                (this.moveSpeed = s.move.speed * o),
                (this.sizeValue = s.size.value * o),
            ...
            initParticle(t) {
              ...
              (t.linksDistance = i.links.distance * e),
                ...
                (t.maxDistance = i.move.distance * e);
            }
          ...
          class ri {
            ...
            set ids(t) {
              this.selectors =
                t instanceof Array ? t.map((t) => "#" + t) : "#" + t;
            }
            load(t) {
              var i, e;
              if (void 0 === t) return;
              const o =
                null !==
                  (e =
                    null !== (i = t.ids) && void 0 !== i ? i : t.elementId) &&
                void 0 !== e
                  ? e
                  : t.el;
              void 0 !== o && (this.ids = o),
            ...
            load(t) {
              ...
              void 0 !== s &&
                (s instanceof Array
                  ...
                  : ((this.onDiv = new ri()), this.onDiv.load(s))),
                this.onHover.load(
              ...
              void 0 !== t &&
                ...
                void 0 !== t.color &&
                  (t.color instanceof Array
                    ? (this.color = t.color.map((t) => ot.create(void 0, t)))
                    : (this.color instanceof Array && (this.color = new ot()),
                      (this.color = ot.create(this.color, t.color)))),
                void 0 !== t.size && (this.size = t.size));
            }
          }
          ...
          class mi {
            constructor() {
              (this.distance = 100), (this.links = new fi());
            }
            get line_linked() {
              return this.links;
            }
          ...
          class Mi {
            ...
            load(t) {
              void 0 !== t &&
                ...
                void 0 !== t.particles &&
                  (this.particles = P.deepExtend({}, t.particles)));
            }
          }
          class Pi {
            constructor() {
          ...
          class Si {
            ...
            load(t) {
              void 0 !== t &&
                ((this.start = ot.create(this.start, t.start)),
                (this.stop = ot.create(this.stop, t.stop)));
            }
          }
          class Ri {
            constructor() {
              (this.gradient = new Si()), (this.radius = 1e3);
            }
            load(t) {
              void 0 !== t &&
          ...
          class Ai {
            constructor() {
              (this.area = new Ri()), (this.shadow = new Ci());
            }
            load(t) {
              void 0 !== t &&
                (this.area.load(t.area), this.shadow.load(t.shadow));
            }
          }
          class Ti {
            constructor() {
          ...
          class Oi {
            ...
            load(t) {
              ...
              if (void 0 === t) return;
              const s =
                null !== (i = t.detectsOn) && void 0 !== i ? i : t.detect_on;
              void 0 !== s && (this.detectsOn = s),
                ...
                !0 ===
                  (null ===
                    (o =
                      null === (e = t.modes) || void 0 === e
                        ? void 0
                        : e.slow) || void 0 === o
                    ? void 0
                    : o.active) &&
                  (this.events.onHover.mode instanceof Array
                    ? this.events.onHover.mode.indexOf(d.slow) < 0 &&
                      this.events.onHover.mode.push(d.slow)
                    : this.events.onHover.mode !== d.slow &&
          ...
          class Di {
            constructor() {
              (this.color = new ot()), (this.opacity = 1);
            }
            load(t) {
              void 0 !== t &&
                (void 0 !== t.color &&
            ...
            load(t) {
              if (void 0 !== t) {
                if (
                  ...
                  const i = t.cover,
                    e =
                      "string" == typeof t.cover ? { color: t.cover } : t.cover;
          ...
          class qi {
            ...
            load(t) {
              void 0 !== t &&
                ...
                void 0 !== t.options &&
                  (this.options = P.deepExtend({}, t.options)));
            }
          }
          class _i {
            constructor() {
          ...
          class Ni {
            constructor() {
              (this.disable = !1), (this.reduce = new Bi());
            }
            load(t) {
              t &&
          ...
          class Ui {
            constructor() {
              (this.autoPlay = !0),
                (this.background = new Li()),
                (this.backgroundMask = new Ii()),
                (this.backgroundMode = new _i()),
                (this.detectRetina = !0),
                (this.fpsLimit = 30),
                (this.infection = new Fi()),
                (this.interactivity = new Oi()),
                (this.manualParticles = []),
                (this.motion = new Ni()),
                (this.particles = new Vt()),
                (this.pauseOnBlur = !0),
                (this.pauseOnOutsideViewport = !1),
                (this.themes = []);
            }
            get fps_limit() {
            ...
            load(t) {
              ...
              const o =
                null !== (i = t.detectRetina) && void 0 !== i
                  ? i
                  : t.retina_detect;
              void 0 !== o && (this.detectRetina = o);
              const s =
                null !== (e = t.fpsLimit) && void 0 !== e ? e : t.fps_limit;
              if (
                ...
                this.backgroundMode.load(t.backgroundMode),
            ...
            setTheme(t) {
              if (t) {
                ...
                let i = this.themes.find(
                  (i) =>
                    i.default.value &&
                    ((i.default.mode === p.dark && t) ||
                      (i.default.mode === p.light && !t))
                );
                i ||
                  (i = this.themes.find(
                    (t) => t.default.value && t.default.mode === p.any
                  )),
                  i && this.load(i.options);
              }
            }
            importPreset(t) {
              this.load(B.getPreset(t));
            }
          }
          var Gi = function (t, i, e, o) {
            return new (e || (e = Promise))(function (s, n) {
              function a(t) {
                try {
                  l(o.next(t));
          ...
          class $i {
            constructor(t, i, ...e) {
              (this.id = t),
                ...
                (this.pageHidden = !1),
                (this.retina = new si(this)),
                (this.canvas = new tt(this)),
                (this.particles = new oi(this)),
                (this.drawer = new ni(this)),
                (this.noise = {
                  generate: () => ({
                ...
                (this.density = 1),
                (this.options = new Ui());
              for (const t of e) this.options.load(B.getPreset(t));
              const o = B.getSupportedShapes();
              for (const t of o) {
                const i = B.getShapeDrawer(t);
                i && this.drawers.set(t, i);
              }
              this.sourceOptions && this.options.load(this.sourceOptions),
                (this.fpsLimit =
                  this.options.fpsLimit > 0 ? this.options.fpsLimit : 60),
                this.options.setTheme(void 0),
                (this.eventListeners = new F(this)),
            ...
            pause() {
              if (
                (void 0 !== this.drawAnimationFrame &&
                  (P.cancelAnimation(this.drawAnimationFrame),
            ...
            draw() {
              this.drawAnimationFrame = P.animate((t) =>
              ...
              t &&
                ("function" == typeof t
                  ? ((this.noise.generate = t),
                    i && (this.noise.init = i),
                    e && (this.noise.update = e))
                  : (t.generate && (this.noise.generate = t.generate),
            ...
            loadTheme(t) {
              return Gi(this, void 0, void 0, function* () {
                this.options.setTheme(t), yield this.refresh();
              });
            }
            start() {
              return Gi(this, void 0, void 0, function* () {
            ...
            init() {
              return Gi(this, void 0, void 0, function* () {
                this.retina.init(),
                  ...
                  (this.fpsLimit =
                    this.options.fpsLimit > 0 ? this.options.fpsLimit : 60);
                const t = B.getAvailablePlugins(this);
                ...
                for (const [, t] of this.plugins)
                  t.init
                    ? t.init(this.options)
                    : void 0 !== t.initAsync &&
                      (yield t.initAsync(this.options));
          ...
          class Ji {
            ...
            static load(t, i, e) {
              return ji(this, void 0, void 0, function* () {
                ...
                if (o) return Ji.set(t, o, i, e);
              });
            }
            static set(t, i, e, o) {
              return ji(this, void 0, void 0, function* () {
                const s = e instanceof Array ? P.itemFromArray(e, o) : e,
                  n = Ji.dom(),
                  a = n.findIndex((i) => i.id === t);
                if (a >= 0) {
                  const t = Ji.domItem(a);
                ...
                if ("canvas" === i.tagName.toLowerCase()) (r = i), (l = !1);
                  ...
                  t.length
                    ? ((r = t[0]),
                      r.className || (r.className = S.canvasClass),
                      (l = !1))
                    : ((l = !0),
                      (r = document.createElement("canvas")),
                      (r.className = S.canvasClass),
                      (r.style.width = "100%"),
                      (r.style.height = "100%"),
                      i.appendChild(r));
                }
                const c = new $i(t, s);
                return (
                  a >= 0 ? n.splice(a, 0, c) : n.push(c),
                  c.canvas.loadCanvas(r, l),
                  yield c.start(),
                  c
                );
              });
            ...
            static loadJSON(t, i, e) {
              return ji(this, void 0, void 0, function* () {
                const o = i instanceof Array ? P.itemFromArray(i, e) : i,
                  s = yield fetch(o);
                if (s.ok) return Ji.load(t, yield s.json());
                Yi(s.status);
              });
            }
              ...
              for (const e of i) {
                ...
                const o = (i, o) => {
                    ...
                    const s = e.retina.pixelRatio,
                      n = { x: o.x * s, y: o.y * s },
                      a = e.particles.quadTree.queryCircle(
                        n,
                        e.retina.sizeValue
                      );
                    t(i, a);
                    ...
                    if (!e.destroyed) {
                      if (c && !d) {
                        const a = t,
                          ...
                          l =
                            null === (i = e.canvas.element) || void 0 === i
                              ? void 0
                              : i.getBoundingClientRect(),
                          c = {
                            x:
                              r.clientX -
                              (null !== (s = null == l ? void 0 : l.left) &&
                              void 0 !== s
                                ? s
                                : 0),
                            y:
                              r.clientY -
                              (null !== (n = null == l ? void 0 : l.top) &&
                              void 0 !== n
                                ? n
                                : 0),
                          };
          ...
          class Ki {
            constructor(t, i, e, o) {
              ...
              (this.absorbers = t),
                ...
                (this.size = r.getValue(e.size) * i.retina.pixelRatio),
                (this.mass =
                  this.size * e.size.density * i.retina.reduceFactor);
              const a = e.size.limit;
              this.limit =
                void 0 !== a
                  ? a * i.retina.pixelRatio * i.retina.reduceFactor
                  : a;
              const l =
                "string" == typeof e.color ? { value: e.color } : e.color;
              (this.color =
                null !== (s = A.colorToRgb(l)) && void 0 !== s
                  ? s
                  : { b: 0, g: 0, r: 0 }),
                (this.position =
            ...
            attract(t) {
              ...
              if (i.draggable) {
                ...
                if (t.clicking && t.downPosition) {
                  r.getDistance(this.position, t.downPosition) <= this.size &&
                    (this.dragging = !0);
              ...
              const e = t.getPosition(),
                ...
                a = Math.atan2(o, s),
                l =
                  (this.mass / Math.pow(n, 2)) *
                  this.container.retina.reduceFactor;
              if (n < this.size + t.getRadius()) {
                const e =
                  0.033 * t.getRadius() * this.container.retina.pixelRatio;
                this.size > t.getRadius() && n < this.size - t.getRadius()
                  ? i.destroy
                    ? t.destroy()
                    : ((t.needsNewPosition = !0),
                      this.updateParticlePosition(t, a, l))
                  : (i.destroy && (t.size.value -= e),
                    this.updateParticlePosition(t, a, l)),
                  ...
                  (this.mass +=
                    ...
                    this.container.retina.reduceFactor);
              } else this.updateParticlePosition(t, a, l);
            }
            resize() {
              const t = this.initialPosition;
              this.position =
                t && P.isPointInside(t, this.container.canvas.size)
                  ? t
                  : this.calcPosition();
            }
            draw(t) {
              t.translate(this.position.x, this.position.y),
                ...
                t.closePath(),
                (t.fillStyle = A.getStyleFromRgb(this.color, this.opacity)),
                t.fill();
            }
            calcPosition() {
              var t, i;
            ...
            updateParticlePosition(t, i, e) {
              var o;
              if (t.destroyed) return;
              const s = this.container.canvas.size;
              if (t.needsNewPosition) {
                const i = t.getRadius();
                (t.position.x = Math.random() * (s.width - 2 * i) + i),
                  (t.position.y = Math.random() * (s.height - 2 * i) + i),
                  (t.needsNewPosition = !1);
              }
              if (this.options.orbits) {
                void 0 === t.orbitRadius &&
                  (t.orbitRadius = r.getDistance(
                    t.getPosition(),
                    this.position
                  )),
                  t.orbitRadius <= this.size &&
                    !this.options.destroy &&
                    (t.orbitRadius =
                      Math.random() * Math.max(s.width, s.height)),
                  void 0 === t.orbitAngle &&
                    (t.orbitAngle = Math.random() * Math.PI * 2);
                const i = t.orbitRadius,
                  n = t.orbitAngle;
                (t.velocity.horizontal = 0),
                  (t.velocity.vertical = 0),
                  (t.position.x = this.position.x + i * Math.cos(n)),
                  (t.position.y = this.position.y + i * Math.sin(n)),
                  (t.orbitRadius -= e),
                  (t.orbitAngle +=
                    ((null !== (o = t.moveSpeed) && void 0 !== o
                      ? o
                      : this.container.retina.moveSpeed) /
                      100) *
                    this.container.retina.reduceFactor);
              } else
                (t.velocity.horizontal += Math.sin(i) * e),
                  (t.velocity.vertical += Math.cos(i) * e);
            }
          }
          class te extends dt {
            constructor() {
          ...
          class ee {
                ...
                (o &&
                  (o instanceof Array
                    ...
                    : (this.interactivityAbsorbers instanceof Array &&
                        (this.interactivityAbsorbers = new ie()),
            ...
            handleClickMode(t) {
              ...
              if (t === Qi.absorber) {
                let t;
                o instanceof Array
                  ? o.length > 0 && (t = P.itemFromArray(o))
                  : (t = o);
                const s =
                    null != t ? t : e instanceof Array ? P.itemFromArray(e) : e,
                  n = i.interactivity.mouse.clickPosition;
                this.addAbsorber(s, n);
              }
            }
            addAbsorber(t, i) {
              const e = new Ki(this, this.container, t, i);
            ...
            loadOptions(t, i) {
              ...
              if (n)
                if (n instanceof Array)
                  ...
                  void 0 === (null == t ? void 0 : t.load) &&
                    (s.interactivity.modes.absorbers = t = new ie()),
                    t.load(n);
                }
            }
          })();
          ...
          function ae(t, i) {
            return { x: ne(t.x, i.x), y: ne(t.y, i.y) };
          }
          class re {
            constructor(t, i, e, o) {
              var s, n, a;
              (this.emitters = t),
                (this.container = i),
                (this.initialPosition = o),
                (this.emitterOptions = P.deepExtend({}, e)),
                (this.position =
                  null !== (s = this.initialPosition) && void 0 !== s
                    ? s
                    : this.calcPosition());
              let r = P.deepExtend({}, this.emitterOptions.particles);
              void 0 === r && (r = {}),
                void 0 === r.move && (r.move = {}),
                void 0 === r.move.direction &&
                  (r.move.direction = this.emitterOptions.direction),
                (this.particlesOptions = r),
                (this.size =
                  null !== (n = this.emitterOptions.size) && void 0 !== n
                    ? n
                    : (() => {
                        const t = new se();
                        return (
                          t.load({ height: 0, mode: v.percent, width: 0 }), t
                        );
                      })()),
                (this.lifeCount =
                  null !== (a = this.emitterOptions.life.count) && void 0 !== a
                    ? a
                    : -1),
                  ...
                  this.pause(),
                    ...
                    this.lifeCount > 0 || this.immortal
                      ? ((this.position = this.calcPosition()),
                        setTimeout(() => {
                          this.play();
                        }, (1e3 * (null !== (t = this.emitterOptions.life.delay) && void 0 !== t ? t : 0)) / this.container.retina.reduceFactor))
                      : this.destroy();
                }, 1e3 * i);
            }
            destroy() {
            ...
            emit() {
              ...
              for (let o = 0; o < this.emitterOptions.rate.quantity; o++)
                t.particles.addParticle(ae(i, e), this.particlesOptions);
            }
          }
          class le {
            constructor() {
          ...
          class de {
            ...
            load(t) {
              void 0 !== t &&
                (void 0 !== t.size &&
                  (void 0 === this.size && (this.size = new se()),
                  this.size.load(t.size)),
                void 0 !== t.direction && (this.direction = t.direction),
                this.life.load(t.life),
                void 0 !== t.particles &&
          ...
          class ue {
            constructor(t) {
              ...
              t.addEmitter = (t, i) => this.addEmitter(t, i);
            }
            init(t) {
              var i, e;
              if (!t) return;
                ...
                (o &&
                  (o instanceof Array
                    ...
                    : (this.interactivityEmitters instanceof Array &&
                        (this.interactivityEmitters = new de()),
            ...
            handleClickMode(t) {
              ...
              if (t === he.emitter) {
                ...
                const s =
                    null != t ? t : e instanceof Array ? P.itemFromArray(e) : e,
                  n = i.interactivity.mouse.clickPosition;
                this.addEmitter(P.deepExtend({}, s), n);
              }
            }
            resize() {
              for (const t of this.array) t.resize();
            ...
            addEmitter(t, i) {
              const e = new re(this, this.container, t, i);
              return this.array.push(e), e;
            }
            removeEmitter(t) {
              const i = this.array.indexOf(t);
            ...
            loadOptions(t, i) {
              ...
              if (n)
                if (n instanceof Array)
                  ...
                  void 0 === (null == t ? void 0 : t.load) &&
                    (s.interactivity.modes.emitters = t = new de()),
                    t.load(n);
                }
            }
          })();
          ...
          class me {
            constructor() {
              (this.color = new ot()), (this.width = 0.5), (this.opacity = 1);
            }
            load(t) {
              var i;
              void 0 !== t &&
                ...
                "string" == typeof this.color.value &&
                  (this.opacity =
                    null !== (i = A.stringToAlpha(this.color.value)) &&
                    void 0 !== i
                      ? i
                      : this.opacity),
                void 0 !== t.opacity && (this.opacity = t.opacity),
          ...
          class ge {
            constructor() {
              (this.enable = !1), (this.stroke = new me());
            }
            get lineWidth() {
            ...
            set lineColor(t) {
              this.stroke.color = ot.create(this.stroke.color, t);
            }
            load(t) {
              var i;
              if (void 0 !== t) {
          ...
          class be {
            constructor() {
              (this.radius = 10), (this.type = ye.path);
            }
            load(t) {
              void 0 !== t &&
                (void 0 !== t.radius && (this.radius = t.radius),
          ...
          class we {
            constructor() {
              this.arrangement = pe.onePerPoint;
            }
            load(t) {
              void 0 !== t &&
          ...
          function Me(t) {
            (t.velocity.horizontal =
              t.velocity.vertical / 2 - t.velocity.horizontal),
              (t.velocity.vertical =
                t.velocity.horizontal / 2 - t.velocity.vertical);
          }
          function Pe(t, i, e) {
            const o = A.colorToRgb(e.color);
            if (o) {
              t.beginPath(), t.moveTo(i[0].x, i[0].y);
              for (const e of i) t.lineTo(e.x, e.y);
              t.closePath(),
                (t.strokeStyle = A.getStyleFromRgb(o)),
                (t.lineWidth = e.width),
                t.stroke();
            }
          }
          function Se(t, i, e, o) {
            t.translate(o.x, o.y);
            const s = A.colorToRgb(e.color);
            s &&
              ((t.strokeStyle = A.getStyleFromRgb(s, e.opacity)),
              (t.lineWidth = e.width),
              t.stroke(i));
          }
          class Re {
            ...
            particlesInitialization() {
              ...
              return (
                !(
                  !t.enable ||
                  t.type !== fe.inline ||
                  (t.inline.arrangement !== pe.onePerPoint &&
                    t.inline.arrangement !== pe.perPoint)
                ) && (this.drawPoints(), !0)
              );
            }
            particlePosition(t) {
              ...
              if (
                ...
                (null !==
                  (e =
                    null === (i = this.raw) || void 0 === i
                      ? void 0
                      : i.length) && void 0 !== e
                  ? e
                  : 0) > 0
              )
                return P.deepExtend({}, t || this.randomPoint());
            }
            particleBounce(t) {
              const i = this.options;
              if (i.enable && i.type !== fe.none && i.type !== fe.inline) {
                if (!this.checkInsidePolygon(t.getPosition())) return Me(t), !0;
              } else if (
                i.enable &&
                i.type === fe.inline &&
                t.initialPosition
                ...
                if (
                  r.getDistance(t.initialPosition, t.getPosition()) >
                  this.polygonMaskMoveRadius
                )
                  return Me(t), !0;
              }
            ...
            checkInsidePolygon(t) {
              ...
              const o = this.container,
                s = this.options;
              if (!s.enable || s.type === fe.none || s.type === fe.inline)
                return !0;
              if (!this.raw) throw new Error(S.noPolygonFound);
              ...
              return s.type === fe.inside ? l : s.type === fe.outside && !l;
            }
            parseSvgPath(t, i) {
              var e, o, s;
              const n = null != i && i;
              ...
              for (let t = 0; t < d.length; t++) {
                const i = d.item(t);
                i &&
                  this.paths.push({ element: i, length: i.getTotalLength() });
              }
              const h = a.retina.pixelRatio,
                u = r.scale / h;
              (this.dimension.width =
                parseFloat(
                  null !== (e = c.getAttribute("width")) && void 0 !== e
                    ? e
                    : "0"
                ) * u),
                ...
                (function (t, i, e) {
                  ...
                  for (const s of t) {
                    ...
                    for (let s = 0; s < n; s++) {
                      ...
                      o.push({ x: a.x * i + e.x, y: a.y * i + e.y });
                    }
                  }
                  return o;
            ...
            getRandomPoint() {
              if (!this.raw || !this.raw.length)
                throw new Error(S.noPolygonDataLoaded);
            ...
            getRandomPointByLength() {
              ...
              if (
                ...
                throw new Error(S.noPolygonDataLoaded);
              const s = P.itemFromArray(this.paths),
            ...
            getEquidistantPointByIndex(t) {
              ...
              return {
                x:
                  (null !== (e = null == d ? void 0 : d.x) && void 0 !== e
                    ? e
                    : 0) *
                    c.scale +
                  (null !==
                    (s =
                      null === (o = this.offset) || void 0 === o
                        ? void 0
                        : o.x) && void 0 !== s
                    ? s
                    : 0),
                y:
                  (null !== (n = null == d ? void 0 : d.y) && void 0 !== n
                    ? n
                    : 0) *
                    c.scale +
                  (null !==
          ...
          const Ce = new (class {
            ...
            needsPlugin(t) {
              ...
              return null !==
                ...
                ? e
                : void 0 !==
                    (null === (o = null == t ? void 0 : t.polygon) ||
                    void 0 === o
                      ? void 0
                      : o.type) && t.polygon.type !== fe.none;
            }
            loadOptions(t, i) {
          ...
          const Ae = new (class extends class {
            constructor() {
              this.initialized = !1;
              const t = new o(),
                i = new G(),
                e = new j();
              B.addShapeDrawer(g.line, new X()),
                B.addShapeDrawer(g.circle, new Y()),
                B.addShapeDrawer(g.edge, t),
                B.addShapeDrawer(g.square, t),
                B.addShapeDrawer(g.triangle, new Q()),
                B.addShapeDrawer(g.star, new Z()),
                B.addShapeDrawer(g.polygon, new K()),
                B.addShapeDrawer(g.char, i),
                B.addShapeDrawer(g.character, i),
                B.addShapeDrawer(g.image, e),
                B.addShapeDrawer(g.images, e);
            }
            init() {
            ...
            loadJSON(t, i, e) {
              return Ji.loadJSON(t, i, e);
            }
            setOnClickHandler(t) {
              Ji.setOnClickHandler(t);
            }
            dom() {
              return Ji.dom();
            }
          ...
          Ae.init();
          const { particlesJS: Te, pJSDom: Ee } = ((t) => {
